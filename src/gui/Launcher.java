...
import javax.swing.*;
/*
 * запуск игры рекомендуемым способом для Java Swing - в новом потоке создаем главную рамку.
 * java Swing recommended way of launching a game - a main frame is created in a new thread.
 */
